...
class TestBoxProject(unittest.TestCase):
    ...
    def test_logo_displayed(self):
        ...
        self.assertEqual(actual.is_displayed(), True, 'Logo is not displayed.')
    ...
    def test_no_user_psw(self):
        ...
        assert actual_error == expected_error, f'expected: {expected_error} actual:{actual_error}'
    ...
    def test_checkout(self):
        ...
        self.assertEqual(actual, expected, 'Checkout not working')
    ...
    def test_logout(self):
        ...
        self.assertEqual(actual, expected, 'logout failed')
    ...
    def test_add_and_remove(self):
        ...
        assert add_to_cart.text == 'ADD TO CART'
