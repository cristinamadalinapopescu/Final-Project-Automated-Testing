...
class TestBoxProject(softest.TestCase):
    ...
    def test_add_and_remove(self):
        ...
        removed_product_button = self.driver.find_element(By.ID, 'add-to-cart-sauce-labs-backpack')
        self.soft_assert(self.assertEqual, removed_product_button.text, 'ADD TO CART',
